...
CREATE TABLE IF NOT EXISTS REVIEWS_LIKES (
    ...
    CONSTRAINT REVIEWS_LIKES_FK_REVIEW_ID FOREIGN KEY (REVIEW_ID) REFERENCES REVIEWS(REVIEW_ID),
    CONSTRAINT REVIEWS_LIKES_FK_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID)
);
...
ALTER TABLE REVIEWS ADD CONSTRAINT IF NOT EXISTS FK_REVIEWS_FILM_ID
