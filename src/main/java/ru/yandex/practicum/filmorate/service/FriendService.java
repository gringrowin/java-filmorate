...
public class FriendService {
    ...
    public User addFriend(Integer userId, Integer friendId) {
        ...
        feedService.addFeedEvent(EventType.FRIEND, OperationType.ADD, userId, friendId);
    ...
    public User deleteFriend(Integer userId, Integer friendId) {
        ...
        feedService.addFeedEvent(EventType.FRIEND, OperationType.REMOVE, userId, friendId);
